...
public class StencilMaker
{
    ...
    public static readonly DepthStencilState stencilContent = new()
    {
        StencilEnable = true,
    ...
    {
        if (stencilTarget == null) stencilTarget = VirtualContent.CreateRenderTarget("stencil-maker", 320, 180, true);
